		...
		System.out.println("===================================");
        	...
        	if(yesOrNO.equals("1")) {
           		try {
	        	 	String sql = "INSERT INTO income VALUES(in_seq.NEXTVAL, ?, ?, ?, ?)";
              			...
              			System.out.println("예외 발생시 처라할 코드: 쿼리문 삽입(수입 1)");
           		}
			...
			try {
	        	  	String sql = "INSERT INTO income VALUES(in_seq.NEXTVAL, ?, ?, ?, ?)";
              			...
              			System.out.println("예외 발생시 처라할 코드: 쿼리문 삽입(수입 2)");
           		}
        	} else {
           		System.out.println("=======================================");
        	...
        	if(yesOrNO.equals("1")) {
          		 try {
	        	  	String sql = "INSERT INTO expenditure VALUES(out_seq.NEXTVAL, ?, ?, ?, ?)";
              			...
              			System.out.println("예외 발생시 처라할 코드: 쿼리문 삽입(지출 1)");
           		}
		} else if (yesOrNO.equals("확인")) {
			try {
	        	  	String sql = "INSERT INTO expenditure VALUES(out_seq.NEXTVAL, ?, ?, ?, ?)";
             			...
             			System.out.println("예외 발생시 처라할 코드: 쿼리문 삽입(지출 2)");
           		}
        	} else {
           		System.out.println("=======================================");
           		System.out.println("입력을 취소하였습니다.");
